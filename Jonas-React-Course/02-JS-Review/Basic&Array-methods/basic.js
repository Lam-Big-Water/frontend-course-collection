...
const summary = `
${title}, a ${pages}-page long book, was written by
${author} and published in
...
console.log(book.translations.spanish || 'Not Translated'); // El señor de los anillos
console.log(book.reviews.librarything.reviewsCount || 'no data'); // 452

console.log(0 || 'no data'); // no data
